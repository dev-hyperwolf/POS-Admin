  ...
  window.HW_TOUR_STEPS = {
    ...
    'Hyperwolf POS.html': {
      ...
      steps: [
        ...
        { title: 'So: walked in, scanned, no remote check — what happens?', ey: 'Policy',
        ...
        { title: 'And the customer who never walked in?', ey: 'Policy',
          body: 'Their choice of two, and both are one-time. <b>A remote ID-check link</b> before the first order — selfie plus document liveness. Or <b>nothing at all</b>: the driver scans their ID at the door on delivery one, which upgrades the account for every order after it.',
          act: 'The remote check is a substitute for the in-store scan, never an extra step on top of one.' },
        ...
        { title: 'One ledger, one identity', ey: 'Identity',
          body: 'In-store scan, door scan and the remote check all write to the same customer record, and a block anywhere is a block everywhere. That is why a guest onboarded at the counter today can order delivery tonight with nothing further asked of them.' },
