  ...
  return (<div style={{ padding:'0 22px' }}>
    ...
    <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'22px 0 0' }}>
      ...
      <div style={{ display:'flex', gap:14 }}>
        <button onClick={toggle} style={{ background:'none', border:'none', color:P.inkDim, cursor:'pointer', padding:0, minHeight:44, minWidth:44, display:'flex', alignItems:'center', justifyContent:'center' }}><Icon name={mode==='dark'?'sun':'moon'} size={18}/></button>
        <button onClick={()=>go('settings')} style={{ background:'none', border:'none', color:P.inkDim, cursor:'pointer', padding:0, minHeight:44, minWidth:44, display:'flex', alignItems:'center', justifyContent:'center' }}><Icon name="settings" size={18}/></button>
      </div>
    </div>
