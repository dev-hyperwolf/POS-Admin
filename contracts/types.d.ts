...
export type PointsKind = 'earned' | 'adjusted' | 'recorded_paid' | 'redeemed';
...
export type IdSource = 'blaze' | 'meadow' | 'treez' | 'weedmaps' | 'didit' | 'hwpos' | 'connecteam' | 'airtable' | 'hyperwolf' | 'metrc' | 'onfleet';
